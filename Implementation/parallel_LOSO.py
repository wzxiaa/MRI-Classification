...
if __name__ == "__main__":
    ...
    path_results_for_each_fold = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_results_for_each_fold_features_{}_{}.csv").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)
    path_results_for_each_param = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_results_for_each_param_setting_features_{}_{}.csv").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)
    path_good_results = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_good_results_features_{}_{}.csv").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)

    pkl_path_results_for_each_fold = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_results_for_each_fold_features_{}_{}.pkl").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)
    pkl_path_results_for_each_param = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_results_for_each_param_setting_features_{}_{}.pkl").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)
    pkl_path_good_results = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/X{}/results/fold{}/outerfold{}_good_results_features_{}_{}.pkl").format(dataset, outer_fold_cv, outer_fold_cv, num_Features_lower, num_Features_upper)
    ...
    # load data
    dataset_path = ("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/data612/X{}.csv").format(dataset)

    X = np.genfromtxt(dataset_path, delimiter=',')
    site = np.genfromtxt("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/data612/Site.csv", delimiter=',')
    Y = np.genfromtxt("/data/shmuel/shmuel1/debbie/environment/parallel_script/MCI/data612/Y.csv", delimiter=',')
